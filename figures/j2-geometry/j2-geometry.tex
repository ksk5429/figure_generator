...
\begin{tikzpicture}[x=1cm, y=1cm,
    ...
    % 2. WATER LAYER
    % ==========================================================
    \filldraw[fill=waterFill, draw=accent, line width=0.4pt]
    ...
    % ==========================================================
    \filldraw[fill=soilFill, draw=black, line width=0.4pt,
    ...
    \draw[black!55, line width=0.4pt, dash pattern=on 2pt off 1.5pt]
        (scourL) -- (scourR);
