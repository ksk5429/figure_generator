"""j3-hydrostatic-profile — u_0(z) at 70g with PPT markers."""

from __future__ import annotations
from pathlib import Path

from figgen import io, utils
from figgen.domain.hydrostatic_profile import plot_hydrostatic_profile
...
def main() -> None:
    ...
    fig, _ = plot_hydrostatic_profile(
        asset.df,
