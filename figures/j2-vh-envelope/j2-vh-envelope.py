"""j2-vh-envelope — VH failure-envelope evolution under progressive scour."""
...
from figgen.domain.vh_envelope import plot_envelope_evolution
...
def main() -> None:
    ...
    fig, _ = plot_envelope_evolution(
        df,
        journal=journal,
        width=width,
        highlight_scours=(0.0, 2.5, 5.0),  # intact, mid, fully-scoured
    )
