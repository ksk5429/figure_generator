"""j3-literature-comparison — range bars per study, saturated + dry panels."""

from __future__ import annotations
from pathlib import Path

from figgen import io, utils
from figgen.domain.literature_comparison import plot_literature_comparison
...
def main() -> None:
    ...
    fig, _ = plot_literature_comparison(
        asset.df,
    ...
    written = utils.save_figure(
        ...
        paper=cfg.get("paper"), claim_id=cfg.get("claim_id"),
        tier=cfg.get("tier"),
