"""j3-plan-view — overhead plan view of the tripod bucket layout."""
...
from figgen.domain.plan_view import plot_plan_view
...
def main() -> None:
    ...
    fig, _ = plot_plan_view(df, journal=journal, width=width)
