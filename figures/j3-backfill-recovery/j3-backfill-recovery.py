"""j3-backfill-recovery — model-scale frequency waterfall across stages."""
...
from figgen.domain.backfill_recovery import plot_backfill_recovery
...
def main() -> None:
    ...
    fig, _ = plot_backfill_recovery(df, journal=journal, width=width)
