"""j2-prediction — four-model baseline-frequency comparison."""
...
from figgen.domain.prediction import plot_baseline_comparison
...
def main() -> None:
    ...
    fig, _ = plot_baseline_comparison(
        df,
        field_f0_hz=float(df["field_f0_hz"].iloc[0]),
        journal=journal,
        width=width,
    )
