"""j3-strain-fixity — strain elevation ratios across scour stages."""
...
from figgen.domain.strain_fixity import plot_strain_fixity
...
def main() -> None:
    ...
    fig, _ = plot_strain_fixity(df, journal=journal, width=width)
