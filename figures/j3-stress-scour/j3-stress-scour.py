"""j3-stress-scour — pre/post-scour stress profiles + Hardin G_max."""
...
from figgen.domain.stress_scour import plot_stress_scour
...
def main() -> None:
    ...
    fig, _ = plot_stress_scour(df, journal=journal, width=width)
