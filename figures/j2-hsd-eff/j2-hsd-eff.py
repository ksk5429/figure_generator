"""j2-hsd-eff — HSD efficiency across depth and scour levels."""
...
from figgen.domain.hsd_eff import plot_hsd_efficiency
...
def main() -> None:
    ...
    fig, _ = plot_hsd_efficiency(df, journal=journal, width=width)
