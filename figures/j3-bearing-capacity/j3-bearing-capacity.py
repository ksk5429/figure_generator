"""j3-bearing-capacity — skirted-footing bearing capacity under scour."""
...
from figgen.domain.bearing_capacity import plot_bearing_capacity
...
def main() -> None:
    ...
    fig, _ = plot_bearing_capacity(df, journal=journal, width=width)
