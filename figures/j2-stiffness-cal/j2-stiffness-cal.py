"""j2-stiffness-cal — G_max/G sensitivity study."""
...
from figgen.domain.stiffness_cal import plot_stiffness_cal
...
def main() -> None:
    ...
    fig, _ = plot_stiffness_cal(df, journal=journal, width=width)
