"""j3-grain-size — PSD curves for the three SNU silica sands."""
...
from figgen.domain.grain_size import plot_grain_size
...
def main() -> None:
    ...
    fig, _ = plot_grain_size(df, journal=journal, width=width)
