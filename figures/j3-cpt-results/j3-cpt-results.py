"""j3-cpt-results — 3-panel CPT characterisation."""
...
from figgen.domain.cpt_results import plot_cpt_results
...
def main() -> None:
    ...
    fig, _ = plot_cpt_results(df, journal=journal, width=width)
