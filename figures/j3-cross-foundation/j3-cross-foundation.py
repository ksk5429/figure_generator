"""j3-cross-foundation — f_1/f_{1,0} vs S/D across foundation types."""

from __future__ import annotations
from pathlib import Path

from figgen import io, utils
from figgen.domain.cross_foundation import plot_cross_foundation
