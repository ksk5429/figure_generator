"""j3-indicator-hierarchy — grouped log-scale bars of T4/T5 at max scour."""
...
from figgen.domain.indicator_hierarchy import plot_indicator_hierarchy
...
def main() -> None:
    ...
    fig, _ = plot_indicator_hierarchy(df, journal=journal, width=width)
