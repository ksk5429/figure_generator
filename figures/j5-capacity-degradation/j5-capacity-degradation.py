"""j5-capacity-degradation — population mean Hmax vs S/D with quantile band."""

from __future__ import annotations
from pathlib import Path

from figgen import io, utils
from figgen.domain.mc_degradation import plot_capacity_degradation
...
def main() -> None:
    ...
    fig, _ = plot_capacity_degradation(
        asset.df,
