"""j3-mode-transition — T5 displacement + strain bending-to-tilting figure."""
...
from figgen.domain.mode_transition import plot_mode_transition
...
def main() -> None:
    ...
    fig, _ = plot_mode_transition(df, journal=journal, width=width)
